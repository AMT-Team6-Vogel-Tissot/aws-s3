...
public class S3ServiceTests {
    ...
    private final Path pathToTestFolder = Paths.get("src", "test", "resources");
    ...
    private final Path path1 = pathToTestFolder.resolve(image1);
    private final Path path2 = pathToTestFolder.resolve(this.image2);
    private final Path path3 = pathToTestFolder.resolve(this.fileText);
